...
TAG=os.environ.get("TAG","mt17"); NORMTV=float(os.environ.get("NORMTV","0.0")); NORMDD=float(os.environ.get("NORMDD","1.5")); LNORM=float(os.environ.get("LNORM","0.0")); LR=float(os.environ.get("LR","5e-3")); ANCHOR=float(os.environ.get("ANCHOR","1.0"))
